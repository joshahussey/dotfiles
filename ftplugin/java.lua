...
local workspace_dir = "/home/josh/workspace/" .. project_name
...
vim.list_extend(
    ...
    vim.split(
        vim.fn.glob(
            "/home/josh/.m2/repository/com/microsoft/java/com.microsoft.java.debug.plugin/0.46.0/com.microsoft.java.debug.plugin-0.46.0.jar",
            1
        ),
        "\n"
    )
...
config["on_attach"] = function(client, bufnr)
    ...
    require("jdtls").setup.add_commands(client, bufnr, {})
    require("settings.remap").lsp_keymaps(bufnr)
    require("settings.remap").debug_keys()
